...
const button = tv({
  base: 'flex flex-row p-1 rounded-full gap-2 items-center justify-center max-w-110 self-center mt-20 mb-10 font-semibold transition duration-500 ease-in-out hover:scale-125',
  variants: {
    color: {
      primary: 'bg-primary',
