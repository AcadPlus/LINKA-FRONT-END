...
export default function Page() {
  return (
    <div className="flex flex-col justify-center items-center w-full md:mb-10">
      <div className="mt-5 flex flex-col md:max-w-screen-lg md:flex-row md:items-center md:gap-32">
        <form
          action=""
          className="flex px-3 gap-2 flex-col w-screen items-center md:w-full"
        >
